 ...
 3)Maası 350000 den büyük olan tüm employee name'leri ekrana yazdırın ve
  bunların içerisinde "Charde Marshall" olduğunu test edin
    ...
    public void test() {
        ...
        //Groovy dili javanin alt dillerden biridir
        //it ifadesi this
        List<Integer> listIdi=json.getList("data.findAll{it.id>10}.id");

        //findAll:Belirtilrn datanin icerisinde istenen sarta bagli olan degerleri getirir.

        System.out.println(listIdi);
        Assert.assertEquals(14,listIdi.size());
